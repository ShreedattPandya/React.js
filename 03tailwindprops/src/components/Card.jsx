...
function Card({username, btnText}) {
    //Here the attribute is props -> props passes the values to individual component individually if passed multiple times
    console.log("props", username);

    // Original Way :
    
    /* function Card(props){ NO CURLYBRACES-OBJECT/VARIABLE
    ...
    <div className="mx-auto max-w-7xl px-2 lg:px-0">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-xl text-gray-600">
          The core team members include {username} and his Team.
          </p>
      </div>
